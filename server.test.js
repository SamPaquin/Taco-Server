...
describe("test server", () => {
  ...
  describe("meats", () => {
    ...
    test("response has expected number of taco meats, and each has a name and image", () => {
      return request(server)
        .get("/meats")
        .then((response) => {
  ...
  describe("toppings", () => {
    ...
    test("response has expected number of taco toppings, and each has a name and image", () => {
      return request(server)
        .get("/toppings")
        .then((response) => {
